...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Qui è possibile specificare messaggi di validazione personalizzati per gli attributi utilizzando
    | la convenzione "attribute.rule" per denominare le linee. Ciò rende veloce specificare un
    | messaggio di lingua personalizzato specifico per una regola di attributo data.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti righe di lingua sono utilizzate per sostituire i nostri segnaposto degli attributi
    | con qualcosa di più leggibile come "Indirizzo e-mail" invece di "email". Questo semplicemente ci aiuta
    | a rendere il nostro messaggio più espressivo.
    |
    */
